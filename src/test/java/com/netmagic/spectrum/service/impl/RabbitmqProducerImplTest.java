...
public class RabbitmqProducerImplTest {
    ...
    public void setUp() {
        ...
        rabbitTemplateMock = PowerMockito.spy(new RabbitTemplate(connectionFactory));
        ...
        Whitebox.setInternalState(rabbitmqProducer, "rabbitTemplate", rabbitTemplateMock);
    ...
    public void testSentToqueue() {
        ...
        rabbitTemplateMock.convertAndSend(topicExchaneNameMock.getName(), QUEUE_NAME, MESSAGE);
